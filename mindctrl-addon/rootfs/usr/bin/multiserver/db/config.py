...
from .queries import ADD_RETENTION_POLICY, CREATE_TABLE, ENABLE_PGVECTOR, CONVERT_TO_HYPERTABLE, ENABLE_TIMESCALE
...
async def insert_summary(state_ring_buffer: collections.deque[dict]):
    ...
    single_summary = summarize_events(["\n".join(summarized_events)])[0]
